...
const EC = Object.freeze({
    ...
    WS_UPGRADE_REQUEST_FAILED    : [ undefined                       , '[252] web socket error, upgrade request failed, code %d %s'],
    ...
    INCOMING_WINDOW_SEQUENCE     : [ AMQP.SESSION.WINDOW_VIOLATION   , '[523] incoming window sequence mismatch at incoming channel %d, incoming link %d, delivery %d, expected %d' ],

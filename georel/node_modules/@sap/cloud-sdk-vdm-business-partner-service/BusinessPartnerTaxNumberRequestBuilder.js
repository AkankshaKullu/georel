...
var BusinessPartnerTaxNumberRequestBuilder = /** @class */ (function (_super) {
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.getByKey = function (businessPartner, bpTaxType) {
        return new core_1.GetByKeyRequestBuilderV2(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, {
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber);
    };
    /**
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, entity);
    };
    /**
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, entity);
    };
    BusinessPartnerTaxNumberRequestBuilder.prototype.delete = function (businessPartnerOrEntity, bpTaxType) {
        return new core_1.DeleteRequestBuilderV2(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, businessPartnerOrEntity instanceof BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber ? businessPartnerOrEntity : {

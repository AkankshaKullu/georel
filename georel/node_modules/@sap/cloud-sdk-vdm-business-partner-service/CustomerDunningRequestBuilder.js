...
var CustomerDunningRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerDunningRequestBuilder.prototype.getByKey = function (customer, companyCode, dunningArea) {
        return new core_1.GetByKeyRequestBuilderV2(CustomerDunning_1.CustomerDunning, {
            Customer: customer,
    ...
    CustomerDunningRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(CustomerDunning_1.CustomerDunning);
    };
    /**
    ...
    CustomerDunningRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(CustomerDunning_1.CustomerDunning, entity);
    };
    /**
    ...
    CustomerDunningRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(CustomerDunning_1.CustomerDunning, entity);
    };
    CustomerDunningRequestBuilder.prototype.delete = function (customerOrEntity, companyCode, dunningArea) {
        return new core_1.DeleteRequestBuilderV2(CustomerDunning_1.CustomerDunning, customerOrEntity instanceof CustomerDunning_1.CustomerDunning ? customerOrEntity : {

...
var CustomerSalesAreaTextRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerSalesAreaTextRequestBuilder.prototype.getByKey = function (customer, salesOrganization, distributionChannel, division, language, longTextId) {
        return new core_1.GetByKeyRequestBuilderV2(CustomerSalesAreaText_1.CustomerSalesAreaText, {
            Customer: customer,
    ...
    CustomerSalesAreaTextRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(CustomerSalesAreaText_1.CustomerSalesAreaText);
    };
    /**
    ...
    CustomerSalesAreaTextRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(CustomerSalesAreaText_1.CustomerSalesAreaText, entity);
    };
    /**
    ...
    CustomerSalesAreaTextRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(CustomerSalesAreaText_1.CustomerSalesAreaText, entity);
    };
    CustomerSalesAreaTextRequestBuilder.prototype.delete = function (customerOrEntity, salesOrganization, distributionChannel, division, language, longTextId) {
        return new core_1.DeleteRequestBuilderV2(CustomerSalesAreaText_1.CustomerSalesAreaText, customerOrEntity instanceof CustomerSalesAreaText_1.CustomerSalesAreaText ? customerOrEntity : {

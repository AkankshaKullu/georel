...
(function (BpContactToAddress) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.ADDRESS_REPRESENTATION_CODE = new core_1.StringField('AddressRepresentationCode', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[contactRelationshipFunction]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.CONTACT_RELATIONSHIP_FUNCTION = new core_1.StringField('ContactRelationshipFunction', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[contactRelationshipDepartment]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.CONTACT_RELATIONSHIP_DEPARTMENT = new core_1.StringField('ContactRelationshipDepartment', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[floor]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.FLOOR = new core_1.StringField('Floor', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[contactPersonBuilding]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.CONTACT_PERSON_BUILDING = new core_1.StringField('ContactPersonBuilding', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[roomNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.ROOM_NUMBER = new core_1.StringField('RoomNumber', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[contactPersonPrfrdCommMedium]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.CONTACT_PERSON_PRFRD_COMM_MEDIUM = new core_1.StringField('ContactPersonPrfrdCommMedium', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[correspondenceShortName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.CORRESPONDENCE_SHORT_NAME = new core_1.StringField('CorrespondenceShortName', BpContactToAddress, 'Edm.String');
    /**
     * Static representation of the [[inhouseMail]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToAddress.INHOUSE_MAIL = new core_1.StringField('InhouseMail', BpContactToAddress, 'Edm.String');
    /**

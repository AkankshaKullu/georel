...
var CustomerTaxGroupingRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerTaxGroupingRequestBuilder.prototype.getByKey = function (customer, customerTaxGroupingCode) {
        return new core_1.GetByKeyRequestBuilderV2(CustomerTaxGrouping_1.CustomerTaxGrouping, {
            Customer: customer,
    ...
    CustomerTaxGroupingRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(CustomerTaxGrouping_1.CustomerTaxGrouping);
    };
    /**
    ...
    CustomerTaxGroupingRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(CustomerTaxGrouping_1.CustomerTaxGrouping, entity);
    };
    CustomerTaxGroupingRequestBuilder.prototype.delete = function (customerOrEntity, customerTaxGroupingCode) {
        return new core_1.DeleteRequestBuilderV2(CustomerTaxGrouping_1.CustomerTaxGrouping, customerOrEntity instanceof CustomerTaxGrouping_1.CustomerTaxGrouping ? customerOrEntity : {

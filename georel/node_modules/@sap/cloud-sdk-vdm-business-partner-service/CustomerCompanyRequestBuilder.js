...
var CustomerCompanyRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerCompanyRequestBuilder.prototype.getByKey = function (customer, companyCode) {
        return new core_1.GetByKeyRequestBuilderV2(CustomerCompany_1.CustomerCompany, {
            Customer: customer,
    ...
    CustomerCompanyRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(CustomerCompany_1.CustomerCompany);
    };
    /**
    ...
    CustomerCompanyRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(CustomerCompany_1.CustomerCompany, entity);
    };
    /**
    ...
    CustomerCompanyRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(CustomerCompany_1.CustomerCompany, entity);
    };

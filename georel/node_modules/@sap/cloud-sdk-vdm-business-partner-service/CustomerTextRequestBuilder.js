...
var CustomerTextRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerTextRequestBuilder.prototype.getByKey = function (customer, language, longTextId) {
        return new core_1.GetByKeyRequestBuilderV2(CustomerText_1.CustomerText, {
            Customer: customer,
            Language: language,
    ...
    CustomerTextRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(CustomerText_1.CustomerText);
    };
    /**
    ...
    CustomerTextRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(CustomerText_1.CustomerText, entity);
    };
    /**
    ...
    CustomerTextRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(CustomerText_1.CustomerText, entity);
    };
    CustomerTextRequestBuilder.prototype.delete = function (customerOrEntity, language, longTextId) {
        return new core_1.DeleteRequestBuilderV2(CustomerText_1.CustomerText, customerOrEntity instanceof CustomerText_1.CustomerText ? customerOrEntity : {

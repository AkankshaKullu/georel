...
import { AllFields, BooleanField, CustomFieldV2, DateField, EntityBuilderType, EntityV2, Field, Link, OneToOneLink, StringField, Time, TimeField } from '@sap-cloud-sdk/core';
/**
...
export declare namespace BusinessPartner {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BUSINESS_PARTNER_BIRTH_DATE_STATUS: StringField<BusinessPartner>;
    /**

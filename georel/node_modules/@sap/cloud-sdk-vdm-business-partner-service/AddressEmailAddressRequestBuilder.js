...
var AddressEmailAddressRequestBuilder = /** @class */ (function (_super) {
    ...
    AddressEmailAddressRequestBuilder.prototype.getByKey = function (addressId, person, ordinalNumber) {
        return new core_1.GetByKeyRequestBuilderV2(AddressEmailAddress_1.AddressEmailAddress, {
            AddressID: addressId,
            Person: person,
    ...
    AddressEmailAddressRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(AddressEmailAddress_1.AddressEmailAddress);
    };
    /**
    ...
    AddressEmailAddressRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(AddressEmailAddress_1.AddressEmailAddress, entity);
    };
    /**
    ...
    AddressEmailAddressRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(AddressEmailAddress_1.AddressEmailAddress, entity);
    };
    AddressEmailAddressRequestBuilder.prototype.delete = function (addressIdOrEntity, person, ordinalNumber) {
        return new core_1.DeleteRequestBuilderV2(AddressEmailAddress_1.AddressEmailAddress, addressIdOrEntity instanceof AddressEmailAddress_1.AddressEmailAddress ? addressIdOrEntity : {

...
var SupplierTextRequestBuilder = /** @class */ (function (_super) {
    ...
    SupplierTextRequestBuilder.prototype.getByKey = function (supplier, language, longTextId) {
        return new core_1.GetByKeyRequestBuilderV2(SupplierText_1.SupplierText, {
            Supplier: supplier,
            Language: language,
    ...
    SupplierTextRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(SupplierText_1.SupplierText);
    };
    /**
    ...
    SupplierTextRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV2(SupplierText_1.SupplierText, entity);
    };
    /**
    ...
    SupplierTextRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV2(SupplierText_1.SupplierText, entity);
    };
    SupplierTextRequestBuilder.prototype.delete = function (supplierOrEntity, language, longTextId) {
        return new core_1.DeleteRequestBuilderV2(SupplierText_1.SupplierText, supplierOrEntity instanceof SupplierText_1.SupplierText ? supplierOrEntity : {
